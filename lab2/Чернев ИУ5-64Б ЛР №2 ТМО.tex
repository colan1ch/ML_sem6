...
\begin{figure}[h!]
    ...
    \newline
    \text Рисунок 1 --- Сравнение методов масштабирования на признаке fare
    \newline
\end{figure}
...
\begin{figure}[h!]
    ...
    \newline
    \text Рисунок 2 --- Тепловая карта пропусков в датасете
    \newline
\end{figure}
...
\begin{figure}[h!]
    ...
    \newline
    \text Рисунок 3 --- Сравнение методов кодирования категориальных признаков
    \newline
\end{figure}
...
\begin{figure}[h!]
    ...
    \newline
    \text Рисунок 4 --- Box plots признаков до масштабирования
    \newline
\end{figure}
...
\begin{figure}[h!]
    ...
    \newline
    \text Рисунок 5 --- Сравнение методов масштабирования (box plots)
    \newline
\end{figure}
...
\begin{figure}[h!]
    ...
    \newline
    \text Рисунок 6 --- Распределение признаков при разных методах масштабирования
    \newline
\end{figure}
