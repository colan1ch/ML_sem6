...
\begin{figure}[h!]
    ...
    \newline
    \small Рисунок 1 --- Гистограммы распределения признаков по классам
    \newline
\end{figure}
...
\begin{figure}[h!]
    ...
    \newline
    \small Рисунок 2 --- Box plots для анализа распределений признаков по классам
    \newline
\end{figure}
...
\begin{figure}[h!]
    ...
    \newline
    \small Рисунок 3 --- Корреляционная матрица признаков датасета Wine
    \newline
\end{figure}
...
\begin{figure}[h!]
    ...
    \newline
    \small Рисунок 4 --- Pairplot для ключевых признаков с разделением по классам
    \newline
\end{figure}
...
\begin{figure}[h!]
    ...
    \newline
    \small Рисунок 5 --- Violin plots для отобранных признаков по классам
    \newline
\end{figure}
...
\begin{figure}[h!]
    ...
    \newline
    \small Рисунок 6 --- Скаттер-плоты пар признаков с разделением по классам
    \newline
\end{figure}
...
\begin{figure}[h!]
    ...
    \newline
    \small Рисунок 7 --- Корреляция признаков с целевой переменной
    \newline
\end{figure}
